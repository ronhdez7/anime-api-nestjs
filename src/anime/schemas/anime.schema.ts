// Generated by ts-to-zod (most of it)
import { z } from "zod";
import {
  AnimeFilmType,
  AnimeFilterOptions,
...
export const genreSchema: z.ZodType<GenreResult> = z.object({
  url: z.string(),
  title: z.string(),
});

export const genreResultSchema: z.ZodType<GenreResult[]> = z.array(genreSchema);
